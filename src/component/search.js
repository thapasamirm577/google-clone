...
import { RiSettings4Line, RiImage2Line, RiArticleLine, RiMapPin2Line, RiMovieLine, RiMore2Line} from 'react-icons/ri';
        ...
        <Fragment>
                ...
                <div className={classes.result_nav_container}>
                    ...
                    <div className={classes.result_nav_input_container}>
                        <div className={classes.result_nav_input_section}>
                            ...
                            <div className={classes.result_nav_microphone_icon}>
                                <FaMicrophone className={classes.result_microphone_icon} />
                            </div>
                            <div className={classes.result_nav_search_icon}>
                                <FaSearch className={classes.result_search_icon} onClick={handleSearch} />
                            </div>
                        </div>
                        <div className={classes.result_nav_menu_section}>
                            <div className={classes.indv_nav_icon}>
                                <a href='#' target="_blank">
                                    <RiSettings4Line className={classes.setting_home_nav} />
                                </a>
                            </div>
                            <div className={classes.indv_nav_icon}>
                                <a href="https://about.google/products/" target="_blank">
                                    <FaTh className={classes.produc_home_nav} />
                                </a>
                            </div>
                            <div className={classes.indv_nav_icon}>
            ...
            <main className={classes.main_search_result}>
                <div className={classes.search_info}>
                    About &nbsp;
                    {data.data?.searchInformation.formattedTotalResults}&nbsp;results
                    &nbsp; ({data.data?.searchInformation.formattedSearchTime} seconds)
                </div> 

                { data.data?.items.map((item)=>{ return(
                <section className={classes.result_show_main} key={item.cachedId}>
